document.getElementById('form').addEventListener('submit', function (event) {
    ...
    xhr.open('GET', 'https://script.google.com/macros/s/AKfycbwqTNg67BiMsGE8hTpTwWAeyfxZrV0tOFJUqMO7vKOUdRaQyIjdKLoXMxH9U1PT6DveJA/exec?name=' + encodeURIComponent(name), true);
...
function submitForm(data) {
    const url = 'https://script.google.com/macros/s/AKfycbwqTNg67BiMsGE8hTpTwWAeyfxZrV0tOFJUqMO7vKOUdRaQyIjdKLoXMxH9U1PT6DveJA/exec';
